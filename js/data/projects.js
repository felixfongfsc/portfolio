...
const projects = [
  ...
  },
  {
    ...
    gallery: [
      { src: "../assets/images/artmax/welcome.png", alt: "ArtMax Welcome Page", caption: "Welcome Screen", description: "Welcome page for new users." },
      { src: "../assets/images/artmax/main.png", alt: "ArtMax Main Page", caption: "Main Dashboard", description: "Central hub for discovering content and mentors." },
      { src: "../assets/images/artmax/article2.png", alt: "ArtMax Article Page", caption: "Article View", description: "Reading experience for educational content or upcoming events." },
      { src: "../assets/images/artmax/mentoring.png", alt: "ArtMax Mentoring Page", caption: "Mentoring Hub", description: "Browsing various lessons, connecting with experienced artists and mentors" },
      { src: "../assets/images/artmax/lesson.png", alt: "ArtMax Lesson Page", caption: "Lesson Page", description: "Looking for details of your interested lesson." },
      { src: "../assets/images/artmax/mentor.png", alt: "ArtMax Mentor Page", caption: "Mentor Profile", description: "Detailed mentor information and booking interface." },
